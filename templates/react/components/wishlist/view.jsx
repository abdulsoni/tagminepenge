				...
				<div className="share">
					{/*<span>Share: &nbsp;</span>*/}
						<div className="row" style={IconStyle}>
							...
							<div className="col-sm-4">
								<TwitterShareButton url={wishlistLink?wishlistLink:null} title={title} via={description} image={image}>
									<TwitterIcon size={25} round={false} />
								</TwitterShareButton>
							</div>
							<div className="col-sm-4">
								<PinterestShareButton url={wishlistLink?wishlistLink:null}  description={description} media={image}>
