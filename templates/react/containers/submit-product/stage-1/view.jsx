			...
			<div className="form">
				...
				<form>
					...
					<div className="form-group">
						...
						<textarea class="form-control" name="description"  rows="5" placeholder="Write your description here, it can be up to 250 characters to describe your product."></textarea>
					</div>
					<div className="form-group">
						<label>Link</label>
